...
// Criação do Menu - do... while // switch case. Jacque comi palhacitos hoje, perdão. 
		...
		break; 
		default: 
		System.out.println(Cores.TEXT_RED_BOLD + Cores.ANSI_BLACK_BACKGROUND + "    OPÇÃO INVÁLIDA! Tente outra vez!       \n");
		}
		...
		if (opcoes == 9) { 
		System.out.println(Cores.TEXT_YELLOW_BOLD +  Cores.ANSI_BLACK_BACKGROUND +"    Obrigado pela preferência! <3          ");
